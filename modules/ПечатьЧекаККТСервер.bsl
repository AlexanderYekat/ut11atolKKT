//Процедура СохранитьНастройкиККТ(Пользователь, типСвязи, ip, COM, портTCP, уровеньОтладки, 
//									имяКассира, флТестовыйРежим, IDWebККТ = "", ПользовательWEB = "", ПWEB = "",
//										ЭмулироватьЗадержкуОтветаОтИСМ = ЛОЖЬ, ИммитацияНеПолученияОтветаОтЧестногоЗнака = ЛОЖЬ,
//											МаксимальноеКолПопытокПроверкиМарки = 5,
//												неЗакрыватьСоедиениеВОднойТранзакцииПечатиЧека = ИСТИНА) экспорт
//	// Вставить содержимое обработчика.                                        
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "ТипСвязи", типСвязи, , Пользователь);
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "IP", ip, , Пользователь);
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "НомерCOM", COM, , Пользователь);
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "Порт_IPККТ", портTCP, , Пользователь);
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "уровеньОтладки", уровеньОтладки, , Пользователь);
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "имяКассира", имяКассира, , Пользователь);
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "флТестовыйРежим", флТестовыйРежим, , Пользователь);
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "IDWebККТ", IDWebККТ, , Пользователь);
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "ПользовательWEB", ПользовательWEB, , Пользователь);
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "ПWEB", ПWEB, , Пользователь);
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "ЭмулироватьЗадержкуОтветаОтИСМ", ЭмулироватьЗадержкуОтветаОтИСМ, , Пользователь);
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "ИммитацияНеПолученияОтветаОтЧестногоЗнака", ИммитацияНеПолученияОтветаОтЧестногоЗнака, , Пользователь);	
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "МаксимальноеКолПопытокПроверкиМарки", МаксимальноеКолПопытокПроверкиМарки, , Пользователь);		
//	ХранилищеОбщихНастроек.Сохранить("НастрокаяСвязиККТ", "неЗакрыватьСоедиениеВОднойТранзакцииПечатиЧека", неЗакрыватьСоедиениеВОднойТранзакцииПечатиЧека, , Пользователь);			
//КонецПроцедуры //СохранитьНастройкиККТ

//функция ПрочитатьНастройкиККТ(Пользователь, Преобразовать = ИСТИНА) экспорт	
//	резИсх = Новый Структура; 
//	// Вставить содержимое обработчика.
//	типСвязи = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "типСвязи", , Пользователь);
//	ip = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "IP", , Пользователь);
//	com = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "НомерCOM", , Пользователь);	
//	портTCP = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "Порт_IPККТ", , Пользователь);	
//	уровеньОтладки = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "уровеньОтладки", , Пользователь);	
//	имяКассира = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "имяКассира", , Пользователь);	
//	флТестовыйРежим = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "флТестовыйРежим", , Пользователь);	
//	IDWebККТ = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "IDWebККТ", , Пользователь);	
//	ПользовательWEB = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "ПользовательWEB", , Пользователь);	
//	ПWEB = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "ПWEB", , Пользователь);	
//	ЭмулироватьЗадержкуОтветаОтИСМ = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "ЭмулироватьЗадержкуОтветаОтИСМ", , Пользователь);	                  
//	ИммитацияНеПолученияОтветаОтЧестногоЗнака = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "ИммитацияНеПолученияОтветаОтЧестногоЗнака", , Пользователь);
//	МаксимальноеКолПопытокПроверкиМарки = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "МаксимальноеКолПопытокПроверкиМарки", , Пользователь);	                  	
//	неЗакрыватьСоедиениеВОднойТранзакцииПечатиЧека = ХранилищеОбщихНастроек.Загрузить("НастрокаяСвязиККТ", "неЗакрыватьСоедиениеВОднойТранзакцииПечатиЧека", , Пользователь);
//	Если неЗакрыватьСоедиениеВОднойТранзакцииПечатиЧека = НЕОПРЕДЕЛЕНО тогда
//		неЗакрыватьСоедиениеВОднойТранзакцииПечатиЧека = ИСТИНА;
//	конецЕсли;
//	
//	резИсх.Вставить("ТипСвязи", типСвязи);
//	резИсх.Вставить("IP", ip);
//	резИсх.Вставить("НомерCOM", com);
//	резИсх.Вставить("Порт_IPККТ", портTCP);
//	резИсх.Вставить("уровеньОтладки", уровеньОтладки);	
//	резИсх.Вставить("имяКассира", имяКассира);		
//	резИсх.Вставить("флТестовыйРежим", флТестовыйРежим);		
//	резИсх.Вставить("IDWebККТ", IDWebККТ);		
//	резИсх.Вставить("ПользовательWEB", ПользовательWEB);		
//	резИсх.Вставить("ПWEB", ПWEB);		
//	резИсх.Вставить("ЭмулироватьЗадержкуОтветаОтИСМ", ЭмулироватьЗадержкуОтветаОтИСМ);		
//	резИсх.Вставить("ИммитацияНеПолученияОтветаОтЧестногоЗнака", ИммитацияНеПолученияОтветаОтЧестногоЗнака);		
//	резИсх.Вставить("МаксимальноеКолПопытокПроверкиМарки", МаксимальноеКолПопытокПроверкиМарки);			
//	резИсх.Вставить("неЗакрыватьСоедиениеВОднойТранзакцииПечатиЧека", неЗакрыватьСоедиениеВОднойТранзакцииПечатиЧека);				
//	Если Преобразовать тогда
//		рез = преобразоватьНастройкиККТ(резИсх);
//	иначе
//		рез = резИсх;
//	конецЕсли;
//	возврат рез;
...
функция преобразоватьНастройкиККТ(исхСтруктура)
	структураНастройкаиСвязиСКТТ = Новый Структура;
	структураНастройкаиСвязиСКТТ.Вставить("ТипСвязи", исхСтруктура.ТипСвязи); //web сервер, по IP ккт, через сервер ККТ, через COM/USB
	структураНастройкаиСвязиСКТТ.Вставить("IP_ККТ", исхСтруктура.IP); 
	структураНастройкаиСвязиСКТТ.Вставить("Порт_IPККТ", исхСтруктура.Порт_IPККТ); 
	структураНастройкаиСвязиСКТТ.Вставить("IP_СерверККТ", исхСтруктура.IP); 
	структураНастройкаиСвязиСКТТ.Вставить("IP_web_сервера_ККТ", исхСтруктура.IP); 
	структураНастройкаиСвязиСКТТ.Вставить("Таймаут_севрерККТ", 1000); 
	структураНастройкаиСвязиСКТТ.Вставить("НомерCOM", исхСтруктура.НомерCOM); 
	структураНастройкаиСвязиСКТТ.Вставить("уровеньОтладки", исхСтруктура.уровеньОтладки); 
	структураНастройкаиСвязиСКТТ.Вставить("имяКассира", исхСтруктура.имяКассира); 
	структураНастройкаиСвязиСКТТ.Вставить("флТестовыйРежим", исхСтруктура.флТестовыйРежим); 
	...
	структураНастройкаиСвязиСКТТ.Вставить("ЭмулироватьЗадержкуОтветаОтИСМ", исхСтруктура.ЭмулироватьЗадержкуОтветаОтИСМ);
	структураНастройкаиСвязиСКТТ.Вставить("ИммитацияНеПолученияОтветаОтЧестногоЗнака", исхСтруктура.ИммитацияНеПолученияОтветаОтЧестногоЗнака);	
	структураНастройкаиСвязиСКТТ.Вставить("МаксимальноеКолПопытокПроверкиМарки", исхСтруктура.МаксимальноеКолПопытокПроверкиМарки);		
	структураНастройкаиСвязиСКТТ.Вставить("неЗакрыватьСоедиениеВОднойТранзакцииПечатиЧека", исхСтруктура.неЗакрыватьСоедиениеВОднойТранзакцииПечатиЧека);			
	Возврат структураНастройкаиСвязиСКТТ;
конецФункции //преобразоватьНастройкиККТ

#Область ФормированияПечатнойФормыЧека
